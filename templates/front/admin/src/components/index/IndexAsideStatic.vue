...
<style lang="scss" scoped>
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip:hover {
				color: #fff !important;
				background: rgba(150, 95, 64, 0.5) !important;
			}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other /deep/ .el-submenu__title {
				...
				box-shadow: inset 1px 1px 5px 0px rgba(0,0,0,0.3) !important;
				color: #fff !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
				padding: 0 40px !important;
				color: #fff !important;
				background: #965F40 url(http://codegen.caihongy.cn/20231103/c4a5cbdd271c46c297ba96d01f4849ef.png) center center/100% 100% no-repeat !important;
				line-height: 50px !important;
				height: 50px !important;
			}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
				padding: 0 40px;
				color: #fff;
				background: #965F40 url(http://codegen.caihongy.cn/20231103/c4a5cbdd271c46c297ba96d01f4849ef.png) center center/100% 100% no-repeat;
				line-height: 50px;
				height: 50px;
			}
