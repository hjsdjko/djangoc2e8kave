<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"60px 0 0 210px","margin":"0 0 0 0","position":"relative","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"none","padding":"8px 150px 8px 20px","alignItems":"center","top":"0","left":"0","background":"linear-gradient(276deg, rgba(255,207,179,0.9) 0%, rgba(255,250,246,0.9) 99%)","display":"flex","width":"100%","position":"fixed","justifyContent":"flex-end","zIndex":"1","height":"60px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"100%","padding":"6px 20px","margin":"15px auto 0 auto","borderColor":"#654B3C","borderStyle":"solid","borderWidth":"4px"}' class="bread-crumbs"></bread-crumbs>
