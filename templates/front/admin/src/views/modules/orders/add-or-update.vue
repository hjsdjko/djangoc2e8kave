	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="用户角色" prop="role">
					<el-input  v-model="ruleForm.role" placeholder="用户角色" clearable  :readonly="ro.role"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="用户角色" prop="role">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.logistics" label="物流" prop="logistics">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"400px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.logistics"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../djangoc2e8kave/upload');
        } else {
